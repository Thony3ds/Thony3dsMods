...
public class Thony3dsModsEffects {
    ...
    public static final RegistryEntry<StatusEffect> XP_POTION = Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(Thony3dsMods.MOD_ID, "xp_potion"), new XpEffect());
